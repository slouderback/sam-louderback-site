      ...
      <div className={styles.cards}>
        ...
        <Paper elevation={6} className={styles.paper}>
          ...
          <p className={styles.paperDescription}>
            ...
            her sell her paintings. If you want a sneak peak check out the rest
            of my projects! In the past ive worked on projects centered around
            algorithim visualization, game creation, and web devlopment.
            Currently my projects are created utilizing C++, Golang, Python, and
            React.
        ...
        <Paper elevation={6} className={styles.paper}>
          ...
          <p className={styles.paperDescription}>
            ...
            in web dev. Outside of tech im really into electric skateboarding.
            Ive been riding my boosted board for a couple of years now and I
            love it. One of my long term goals in life is to learn how to fly a
            plane!
